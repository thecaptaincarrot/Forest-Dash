...
func _unhandled_input( event ):
	...
	if event.is_action_pressed("ui_left") or event.is_action_pressed("editor_left"):
		__keys[0] = true
	if event.is_action_pressed("ui_up") or event.is_action_pressed("editor_up"):
		__keys[1] = true
	if event.is_action_pressed("ui_right") or event.is_action_pressed("editor_right"):
		__keys[2] = true
	if event.is_action_pressed("ui_down") or event.is_action_pressed("editor_down"):
		__keys[3] = true
	if event.is_action_released("ui_left") or event.is_action_released("editor_left"):
		__keys[0] = false
	if event.is_action_released("ui_up") or event.is_action_released("editor_up"):
		__keys[1] = false
	if event.is_action_released("ui_right") or event.is_action_released("editor_right"):
		__keys[2] = false
	if event.is_action_released("ui_down") or event.is_action_released("editor_down"):
		__keys[3] = false
